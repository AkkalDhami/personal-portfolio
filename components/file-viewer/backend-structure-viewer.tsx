...
export default function BackendStructureViewer({
  ...
  if (sidebar === "right") {
    return (
      <div
        className={cn("flex h-130 w-full max-w-3xl overflow-auto", className)}>
        <div className="w-full max-w-3xl overflow-auto p-4">
  ...
  return (
    <div
      className={cn(
        "flex h-130 w-full max-w-3xl overflow-auto rounded-xl",
        className
      )}
      style={{
        backgroundColor: bg,
