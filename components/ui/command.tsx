...
function CommandFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      className={cn(
        "text-muted-foreground bg-background flex items-center justify-between gap-2 border-t px-5 py-3 text-xs",
        className
      )}
